...
export const login = async (payload) => {
   try {
      const response = await axios.post(`${ServerIP}/api/v1/driver/authenticate/login`, payload);
...
export const contactus = async (payload) => {
   try {
      const response = await axios.post(`${ServerIP}/api/v1/forms/contactus`, payload);
